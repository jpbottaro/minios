...
uno le daba un path y devolvian el inodo correspondiente. Al encontrarme con
tener que implementar las llamadas de sistema de directorios me di cuenta que
...
también hay que colocar los links a '.' y '..'.

Por último, chdir() cambia el directorio actual (el inodo del directorio actual
se guarda en la tabla del proceso)
