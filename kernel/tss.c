...
int add_tss(unsigned int pos, unsigned int user_cr3)
{
    ...
    tss[pos].cs     = SEG_DESC_UCODE;
    tss[pos].ds     = SEG_DESC_UDATA;
    tss[pos].ss     = SEG_DESC_UDATA;
    tss[pos].fs     = SEG_DESC_UDATA;
    tss[pos].gs     = SEG_DESC_UDATA;
    tss[pos].es     = SEG_DESC_UDATA;
